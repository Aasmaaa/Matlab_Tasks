...
fill(rectXpoints,rectYpoints,[1 1 0]) %setting yellow color
hold on 
rectXpoints = [-2 -2 2 2 -2];
...
% looping 5 times 
for i=1:1:5
%illuminate the red circle and dimming the other ones by facecolor
rectangle('Position',[-6 55 12 12],'FaceColor',[1 0 0],'Curvature',[1 1]) %converting rect to circle using curvature 
rectangle('Position',[-6 40 12 12],'FaceColor',[0.5 .5 0],'Curvature',[1 1])
rectangle('Position',[-6 25 12 12],'FaceColor',[0 .5 0],'Curvature',[1 1])
pause(1)  %pausing 1 sec
